<?php /* Smarty version 2.6.26, created on 2018-04-27 10:12:00
...
" class="text-input small-input" name="volume" id="volume" />
              ...
              <p id="dlt">
              <label><font class="red"> * </font>准驾级别：</label>
              <select id="mold" name="mold" style="width:200px">
                  <option value="0">-----选择准驾级别-----</option>
                  <?php unset($this->_sections['i']);
$this->_sections['i']['name'] = 'i';
...
" <?php if ($this->_tpl_vars['driverlicensetypeList'][$this->_sections['i']['index']]['value'] == $this->_tpl_vars['car']['mold']): ?>selected="selected"<?php endif; ?>>
...
<?php echo $this->_tpl_vars['driverlicensetypeList'][$this->_sections['i']['index']]['name']; ?>
              ...
              <select id="isrun" name="isrun" style="width:200px">
                  <option value="0" <?php if ($this->_tpl_vars['car']['isrun'] == 0): ?>selected="selected"<?php endif; ?>>空闲</option>
                  <option value="1" <?php if ($this->_tpl_vars['car']['isrun'] == 1): ?>selected="selected"<?php endif; ?>>占用</option>
              </select>
              </p>
