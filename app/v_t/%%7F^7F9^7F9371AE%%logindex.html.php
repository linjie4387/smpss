<?php /* Smarty version 2.6.26, created on 2018-11-06 16:22:26
         compiled from simpla/device/logindex.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'get_url', 'simpla/device/logindex.html', 11, false),)), $this); ?>
...
<div id="main-content">
    ...
    <p id="page-intro">查看和管理仪器文件上传历史。</p>
    <div class="clear"></div>
...
">导入仪器</a></li>
      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
            <form action="<?php echo smarty_function_get_url(array('rule' => '/device/logindex'), $this);?>
