<?php /* Smarty version 2.6.26, created on 2017-05-19 14:04:12
...
<div id="main-content">
  ...
  <p id="page-intro">1.你可以在这里上传试剂文件。2.带 <span class="red">*</span> 的项目必填</p>
  <div class="clear"></div>
...
">试剂查询</a></li>
        <li><a href="#tab1" class="default-tab">导入试剂</a></li>
...
">更新记录</a></li>
    ...
    <div class="content-box-content">
      <div class="tab-content default-tab" id="tab1">
        <div class="form">
          <form action="<?php echo smarty_function_get_url(array('rule' => '/reagent/addreagent'), $this);?>
