<?php /* Smarty version 2.6.26, created on 2017-06-02 15:52:51
...
<section>
    <div>
        ...
        <div class="info w-100">
            <div><strong>预订单号</strong>：<?php echo $this->_tpl_vars['hospitalorder']['hospitalorder_id']; ?>
</div>
            <div><strong>医院</strong>：<?php echo $this->_tpl_vars['hospitalorder']['hospital_name']; ?>
</div>
            <div><strong>科室</strong>：<?php echo $this->_tpl_vars['hospitalorder']['office_name']; ?>
</div>
            <div><strong>提交人</strong>：<?php echo $this->_tpl_vars['hospitalorder']['name']; ?>
</div>
            <div><strong>是否代下单</strong>：<?php if ($this->_tpl_vars['hospitalorder']['is_agent'] == 2): ?>是<?php else: ?>否<?php endif; ?></div>
            <div><strong>联系电话</strong>：<?php echo $this->_tpl_vars['hospitalorder']['mobile']; ?>
</div>
            <div><strong>下单时间</strong>：<?php echo $this->_tpl_vars['hospitalorder']['preapply_time']; ?>
</div>
            <div><strong>备注</strong>：<?php echo $this->_tpl_vars['hospitalorder']['remark']; ?>
</div>
        </div>
    </div>
    <div class="blank-1"></div>
