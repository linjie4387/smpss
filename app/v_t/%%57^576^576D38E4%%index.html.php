<?php /* Smarty version 2.6.26, created on 2017-05-10 11:29:30
...
" title="备注管理">
                  ...
                  <td style="min-width:80px;">
                  	...
                  	<a class="btn btn-primary btn-xs" href="<?php echo smarty_function_get_url(array('rule' => '/order/updatehospitalorder','data' => ((is_array($_tmp='oid=')) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_tpl_vars['hospitalorderList'][$this->_sections['i']['index']]['hospitalorder_id']) : smarty_modifier_cat($_tmp, $this->_tpl_vars['hospitalorderList'][$this->_sections['i']['index']]['hospitalorder_id']))), $this);?>
">
                  			接收处理
                  	</a>
