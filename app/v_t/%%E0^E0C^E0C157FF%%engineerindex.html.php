<?php /* Smarty version 2.6.26, created on 2017-05-19 14:01:20
    ...
    <div class="content-box">
      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
            <form action="<?php echo smarty_function_get_url(array('rule' => '/user/engineerindex'), $this);?>
...
?>
                <tr>
                  ...
                  <td>
                  	<a style="margin:10px;" href="<?php echo smarty_function_get_url(array('rule' => '/user/addengineer','data' => ((is_array($_tmp='uid=')) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_tpl_vars['weichatuserList'][$this->_sections['i']['index']]['weichatuser_id']) : smarty_modifier_cat($_tmp, $this->_tpl_vars['weichatuserList'][$this->_sections['i']['index']]['weichatuser_id']))), $this);?>
" title="编辑">
                  		<img src="<?php echo $this->_tpl_vars['root_dir']; ?>
/assets/simpla/images/icons/edit.png" alt="编辑" />
                  	</a>
                  	<?php if ($this->_tpl_vars['weichatuserList'][$this->_sections['i']['index']]['level'] == 1): ?>&nbsp;
                  	<a style="margin:10px;" href="<?php echo smarty_function_get_url(array('rule' => '/user/dispatchengineer','data' => ((is_array($_tmp='uid=')) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_tpl_vars['weichatuserList'][$this->_sections['i']['index']]['weichatuser_id']) : smarty_modifier_cat($_tmp, $this->_tpl_vars['weichatuserList'][$this->_sections['i']['index']]['weichatuser_id']))), $this);?>
" title="分配区县">
                  		<img src="<?php echo $this->_tpl_vars['root_dir']; ?>
/assets/simpla/images/icons/settings.png" alt="分配区县" />
                  	</a>
                  	<?php endif; ?>
...
<script>
    function do_del_user(uname, uid,obj){
		...
		$.post("<?php echo smarty_function_get_url(array('rule' => '/user/deleteengineer'), $this);?>
",{
			weichatuser_id : uid
		},function(res){
			console.log(res);
