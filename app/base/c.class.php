...
class base_c extends SGui {
	...
	public function __construct() {
		...
		$this->params ['logo_dir'] = base_Constant::LOGO_DATA_DIR;
		self::getRights ();
	}
	 ...
	 */
	function ajax_res($msg = "", $errcode = 0, $data = NULL) {
		$res['code'] = $errcode;
		$res['msg'] = $msg;
		$res['data'] = $data;
	 ...
	 * 分页
	 */
	function PageBar($count, $limit, $i_page, $inPath, $style = 'style2', $getPath = "") {
